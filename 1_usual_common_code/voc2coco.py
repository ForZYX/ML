...
train_xmls = glob.glob('dataset/data/train/xml/*.xml')
PascalVOC2coco(train_xmls, 'dataset/data/train.json')

train_xmls = glob.glob('dataset/data/test/xml/*.xml')
PascalVOC2coco(train_xmls, 'dataset/data/test.json')