...
from object_detection.model.utils.bbox_tools import bbox2loc, bbox_iou, loc2bbox
...
class ProposalCreator:
    # unNOTE: I'll make it un-differential
    ...
    ::
        ...
        min_size (int): A parameter to determine the threshold on
