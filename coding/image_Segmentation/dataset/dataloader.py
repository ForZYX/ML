...
class DataLoader(DataLoader):
    ...
    def load_patient(img_path):
        ...
        img_dir = os.path.join(base, img_path)
        img = np.load(img_dir, mmap_mode="r")
        return img
...
if __name__ == "__main__":
    ...
    util.plot_comparison(imgs_list, captions, n_col=len(imgs_list),
                          figsize=(15, 15), cmap=None)
    util.plot_comparison(segs_list, captions, n_col=len(imgs_list),
                          figsize=(15, 15), cmap=None)
