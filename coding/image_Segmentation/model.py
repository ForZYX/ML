...
if __name__ == '__main__':
    # model = smp.Unet(encoder_name='resnet18', decoder_use_batchnorm=True, in_channels=3, classes=1,
    #                  encoder_weights=None).to(device)
    # print(summary(model, (3, 512, 512)))

    model_me = UNet(3, 64, 3).to(device)
    print(summary(model_me, (3, 512, 512)))
