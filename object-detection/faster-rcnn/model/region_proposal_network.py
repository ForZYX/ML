...
from object_detection.model.utils.bbox_tools import generate_anchor_base
from object_detection.model.utils.create_tool import ProposalCreator
...
class RegionProposalNetwork(nn.Module):
    ...
    ::
        ...
        anchor_scales (list of numbers):
            ...
            window.
        feat_stride (int):
            Stride size after extracting features from an
            image.
        initialW (callable):
            Initial weight value. If :obj:`None` then this
